...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function connectAudioStreamWebSocket() {
    ...
    const ws = new WebSocket(`ws://localhost:8080/audio-stream?userId=${encodeURIComponent(window.audioApp.userId)}`);
    ...
    ws.onopen = () => {
        ...
        //TODO think about this, one would need to differentiate between actual audio sent or init message sent if it is done like this.
        //const userId = window.audioApp.userId || "Unknown";
